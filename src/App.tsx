...
export default function App() {
  ...
  const { data, addPlataforma, deletePlataforma, addLancamento, getLancamentosByMesAno, getLancamentosByPlataforma } = useAppData()
    ...
    <div className="app">
      ...
      <main className="main">
        {activeTab === 'lancamentos' && (
          <TabLancamentos plataformas={data.plataformas} lancamentosByMesAno={lancamentosByMesAno} onAddLancamento={addLancamento} />
        )}
